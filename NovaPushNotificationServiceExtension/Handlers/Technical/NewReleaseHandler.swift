...
final class NewReleaseHandler: PushNotificationHandler {
    ...
    init(payload: NewReleasePayload,
    ...
    func handle(callbackQueue: DispatchQueue?,
        ...
        dispatchInQueueWhenPossible(callbackQueue) {
            ...
            let title = localizedString(LocalizationKeys.Technical.newReleaseTitle,
                                        locale: locale)
            let subtitle = localizedString(LocalizationKeys.Technical.newReleaseSubtitle,
