...
enum KeystoreTagV2: String, CaseIterable {
    ...
    static func derivationTagForMetaId(_ metaId: String, accountId: AccountId, isEthereumBased: Bool) -> String {
        if isEthereumBased {
    ...
    static func raiseTokenTagForMetaId(_ metaId: String, accountId: AccountId) -> String {
        createTagForMetaId(metaId, accountId: accountId, suffix: "-raiseToken")
    }
