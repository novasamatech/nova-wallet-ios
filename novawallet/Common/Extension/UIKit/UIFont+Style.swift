...
extension UIFont {
    ...
    static var regularCallout: UIFont { R.font.publicSansRegular(size: 16)! }
    ...
    static var semiBoldCaption1: UIFont { R.font.publicSansSemiBold(size: 12)! }
    ...
    static var swipeGovMaxRegular: UIFont { R.font.publicSansRegular(size: 40)! }
    static var swipeGovMaxEmphasized: UIFont { R.font.publicSansSemiBold(size: 40)! }
}
