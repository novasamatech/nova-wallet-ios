...
class PasswordInputView: BackgroundedContentControl {
    ...
    private func layoutContent() {
        ...
        let actionsWidth: CGFloat = watchPasswordButton.intrinsicContentSize.width
    ...
    func configureContentViewIfNeeded() {
        ...
        stackView.addArrangedSubview(watchPasswordButton)
    ...
    private func configureClearHandlers() {
        watchPasswordButton.addTarget(
            self,
            action: #selector(actionWatchPassword),
            for: .touchUpInside
        )
    }
...
extension PasswordInputView: UITextFieldDelegate {
    ...
    func textFieldShouldReturn(_: UITextField) -> Bool {
        if let delegate = delegate {
            return delegate.passwordInputViewShouldReturn(self)
        } else {
    ...
    func textFieldShouldBeginEditing(_: UITextField) -> Bool {
        delegate?.passwordInputViewWillStartEditing(self)
        return true
    }
}
