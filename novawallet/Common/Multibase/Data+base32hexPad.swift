...
extension String {
    func base32hexPadDecodedData() -> Data? {
        let base32HexAlphabet = "0123456789ABCDEFGHIJKLMNOPQRSTUV"
        let paddingChar = "="
        ...
        while currentIndex < endIndex {
            ...
            for _ in 0 ..< chunkLength {
                ...
                guard let charIndex = base32HexAlphabet.firstIndex(of: char) else {
                    return nil
                }

                let charValue = UInt64(base32HexAlphabet.position(charIndex))
