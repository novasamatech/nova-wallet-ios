...
final class GiftTransferConfirmInteractor: GiftTransferInteractor {
    ...
    init(
        ...
        feeProxy: any ExtrinsicFeeProxyProtocol,
        transferCommandFactory: SubstrateTransferCommandFactory,
        extrinsicService: any ExtrinsicServiceProtocol,
        walletRemoteWrapper: any WalletRemoteSubscriptionWrapperProtocol,
        ...
        substrateStorageFacade: any StorageFacadeProtocol,
        transferAggregationWrapperFactory: any AssetTransferAggregationFactoryProtocol,
