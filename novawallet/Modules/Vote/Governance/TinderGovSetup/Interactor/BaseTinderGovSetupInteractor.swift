...
class BaseTinderGovSetupInteractor: AnyCancellableCleaning {
...
// MARK: TinderGovSetupInteractorInputProtocol

extension BaseTinderGovSetupInteractor: TinderGovSetupInteractorInputProtocol {
    func setup() {
        makeSubscriptions()
    }
...
extension BaseTinderGovSetupInteractor: WalletLocalSubscriptionHandler, WalletLocalStorageSubscriber {
...
extension BaseTinderGovSetupInteractor: PriceLocalSubscriptionHandler, PriceLocalStorageSubscriber {
...
extension BaseTinderGovSetupInteractor: GeneralLocalStorageSubscriber, GeneralLocalStorageHandler {
...
extension BaseTinderGovSetupInteractor: SelectedCurrencyDepending {
    func applyCurrency() {
...
extension BaseTinderGovSetupInteractor {
