...
class GovernanceDelegateViewModelFactory {
    ...
    private func createStatsViewModel(
        ...
        return .init(
            delegationsTitle: R.string(preferredLanguages: locale.rLanguages
            ).localizable.delegationsDelegations(),
            delegations: delegations,
            votesTitle: R.string(preferredLanguages: locale.rLanguages
            ).localizable.delegationsDelegatedVotes(),
            votes: totalVotes,
            lastVotesTitle: R.string(preferredLanguages: locale.rLanguages
