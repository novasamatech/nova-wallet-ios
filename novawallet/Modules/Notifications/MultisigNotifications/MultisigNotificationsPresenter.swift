...
private extension MultisigNotificationsPresenter {
    ...
    func showNoMultisigWalletsAlert() {
        ...
        let learnMoreActionTitle = R.string(preferredLanguages: localizationManager.selectedLocale.rLanguages
        ).localizable.commonLearnMore()
        let gotItActionTitle = R.string(preferredLanguages: localizationManager.selectedLocale.rLanguages
