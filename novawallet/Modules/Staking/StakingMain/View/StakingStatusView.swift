...
extension StakingStatusView {
    func bind(status: StakingDashboardEnabledViewModel.Status, locale: Locale) {
        ...
        case .active:
            ...
            detailsLabel.text = R.string(preferredLanguages: locale.rLanguages).localizable.stakingNominatorStatusActive().uppercased()
        case .inactive:
            ...
            detailsLabel.text = R.string(preferredLanguages: locale.rLanguages).localizable.stakingNominatorStatusInactive().uppercased()
        case .waiting:
            ...
            detailsLabel.text = R.string(preferredLanguages: locale.rLanguages).localizable.commonWaiting().uppercased()
        }
    }
}
