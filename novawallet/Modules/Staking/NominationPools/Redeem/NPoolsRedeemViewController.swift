...
final class NPoolsRedeemViewController: UIViewController, ViewHolder {
    typealias RootViewType = NPoolsRedeemViewLayout

    let presenter: NPoolsRedeemPresenterProtocol

    init(presenter: NPoolsRedeemPresenterProtocol, localizationManager: LocalizationManagerProtocol) {
