...
final class SwapSetupViewLayout: ScrollableContainerLayoutView {
    ...
    func setup(locale: Locale) {
        ...
        routeCell.titleButton.imageWithTitleView?.title = R.string(preferredLanguages: locale.rLanguages
        ).localizable.swapsDetailsRoute()

        execTimeCell.titleButton.imageWithTitleView?.title = R.string(preferredLanguages: locale.rLanguages
        ).localizable.swapsDetailsExecTime()

        networkFeeCell.titleButton.imageWithTitleView?.title = R.string(preferredLanguages: locale.rLanguages
