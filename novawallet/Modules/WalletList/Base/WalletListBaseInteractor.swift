...
class WalletListBaseInteractor {
    weak var basePresenter: WalletListBaseInteractorOutputProtocol?
...
extension WalletListBaseInteractor: WalletListBaseInteractorInputProtocol {}

extension WalletListBaseInteractor: WalletLocalStorageSubscriber, WalletLocalSubscriptionHandler {
