...
class OldBaseAccountCreatePresenter {
...
extension OldBaseAccountCreatePresenter: OldAccountCreatePresenterProtocol {
    func setup() {
        interactor.setup()
    }
...
extension OldBaseAccountCreatePresenter: AccountCreateInteractorOutputProtocol {
...
extension OldBaseAccountCreatePresenter: ModalPickerViewControllerDelegate {
...
extension OldBaseAccountCreatePresenter: Localizable {
