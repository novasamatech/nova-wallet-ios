...
final class RootInteractor {
    ...
    let chainRegistryFacade: ChainRegistryFacadeProtocol.Type
    ...
    init(
        ...
        chainRegistryFacade: ChainRegistryFacadeProtocol.Type,
        ...
        self.chainRegistryFacade = chainRegistryFacade
...
extension RootInteractor: RootInteractorInputProtocol {
    ...
    func setup() {
        ...
        chainRegistryFacade.sharedRegistry.syncUp()
    }
}
