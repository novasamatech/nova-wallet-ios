...
final class ContactsListViewModelFactory: ContactsListViewModelFactoryProtocol {
    ...
    func createContactViewModelListFromItems(
        ...
        if !localItems.isEmpty {
            let viewModels = createSearchViewModelListFromItems(
                localItems,
            ...
            let section = ContactSectionViewModel(
                title: sectionTitle,
                items: viewModels
            )
    ...
    func createSearchViewModelListFromItems(
        _ items: [SearchData],
        parameters: ContactModuleParameters,
        locale: Locale,
        delegate: ContactViewModelDelegate?,
    ...
    func createBarActionForAccountId(
        ...
        let viewModel = WalletBarActionViewModel(
