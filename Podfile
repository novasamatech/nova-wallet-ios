...
abstract_target 'novawalletAll' do
  ...
  pod 'SubstrateSdk', :git => 'https://github.com/nova-wallet/substrate-sdk-ios.git', :tag => '3.7.0'
  pod 'SwiftLint'
  ...
  pod 'Foundation-iOS', :git => 'https://github.com/novasamatech/Foundation-iOS.git', :commit => 'f4b3042c28421be6b965a9c5b8d79344daca8c9e'
  pod 'SwiftyBeaver'
