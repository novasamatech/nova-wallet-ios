...
abstract_target 'novawalletAll' do
  ...
  pod 'SubstrateSdk', :git => 'https://github.com/nova-wallet/substrate-sdk-ios.git', :commit => '9fed266e18d3b1b0b94ff57ad6acf0a5fa964739'
  pod 'SwiftLint'
  pod 'R.swift', :inhibit_warnings => true
  pod 'SoraKeystore', '~> 1.0.0'
  pod 'SoraUI', :git => 'https://github.com/ERussel/UIkit-iOS.git', :tag => '1.13.0'
  pod 'Operation-iOS', :git => 'https://github.com/novasamatech/Operation-iOS', :commit => 'a183d0c990742580e2afbb2529064395ef27f5ff'
