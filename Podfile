...
abstract_target 'novawalletAll' do
  ...
  pod 'SubstrateSdk', :git => 'https://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@github.com/nova-wallet/substrate-sdk-ios.git', :commit => '5e3550164e0ed08e4fbace45ce5fbc01b95f2355'
  pod 'SwiftLint'
