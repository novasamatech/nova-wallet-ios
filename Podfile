...
abstract_target 'novawalletAll' do
  ...
  pod 'SubstrateSdk', :git => 'https://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@github.com/nova-wallet/substrate-sdk-ios.git', :commit => 'e8aebcef7dfca31341dd4b8b9a6af0be0fecb0d7'
  pod 'SwiftLint'
