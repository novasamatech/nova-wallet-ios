...
final class CloudBackupSyncTests: XCTestCase {
    ...
    func testDetectLocalChanges() throws {
        try performSyncTest(
            ...
            validateClosure: { params in
                ...
                do {
                    let afterBackupWallets = Set(params.localWalletsAfterSync.map(\.info))
        ...
        try performSyncTest(
            ...
            validateClosure: { params in
                ...
                do {
                    ...
                    XCTAssertEqual(backupWalletsAfterSync, Set(params.localWalletsAfterSync.map(\.info)))
    ...
    private func syncAndWait<T>(
        ...
        service.subscribeState(
            ...
            if
                case let .enabled(optSyncResult, _) = result,
