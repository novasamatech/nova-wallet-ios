...
public class KeystoreProtocolStub: KeystoreProtocol {
    public func addKey(_: Data, with _: String) throws {
        DefaultValueRegistry.defaultValue(for: Void.self)
    }

    public func updateKey(_: Data, with _: String) throws {
        DefaultValueRegistry.defaultValue(for: Void.self)
    }

    public func fetchKey(for _: String) throws -> Data {
        DefaultValueRegistry.defaultValue(for: Data.self)
    }

    public func checkKey(for _: String) throws -> Bool {
        DefaultValueRegistry.defaultValue(for: Bool.self)
    }

    public func deleteKey(for _: String) throws {
        DefaultValueRegistry.defaultValue(for: Void.self)
    }
}
...
public class MockSecretDataRepresentable: SecretDataRepresentable, Cuckoo.ProtocolMock {
    ...
    public struct __StubbingProxy_SecretDataRepresentable: Cuckoo.StubbingProxy {
        ...
        func asSecretData() -> Cuckoo.ProtocolStubFunction<Void, Data?> {
    ...
    public struct __VerificationProxy_SecretDataRepresentable: Cuckoo.VerificationProxy {
        ...
        @discardableResult
        func asSecretData() -> Cuckoo.__DoNotUse<Void, Data?> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
...
public class SecretStoreManagerProtocolStub: SecretStoreManagerProtocol {
    public func loadSecret(for _: String, completionQueue _: DispatchQueue, completionBlock _: @escaping (SecretDataRepresentable?) -> Void) {
        DefaultValueRegistry.defaultValue(for: Void.self)
    }

    public func saveSecret(_: SecretDataRepresentable, for _: String, completionQueue _: DispatchQueue, completionBlock _: @escaping (Bool) -> Void) {
        DefaultValueRegistry.defaultValue(for: Void.self)
    }

    public func removeSecret(for _: String, completionQueue _: DispatchQueue, completionBlock _: @escaping (Bool) -> Void) {
        DefaultValueRegistry.defaultValue(for: Void.self)
    }

    public func checkSecret(for _: String, completionQueue _: DispatchQueue, completionBlock _: @escaping (Bool) -> Void) {
        DefaultValueRegistry.defaultValue(for: Void.self)
    }

    public func checkSecret(for _: String) -> Bool {
        DefaultValueRegistry.defaultValue(for: Bool.self)
    }
}
...
public class JSONRPCResponseHandlingStub: JSONRPCResponseHandling {
    public func handle(data _: Data, for _: UInt16) {
        DefaultValueRegistry.defaultValue(for: Void.self)
    }

    public func handle(error _: Error, for _: UInt16) {
        DefaultValueRegistry.defaultValue(for: Void.self)
    }
}
...
public class MockJSONRPCSubscribing: JSONRPCSubscribing, Cuckoo.ProtocolMock {
    ...
    public struct __VerificationProxy_JSONRPCSubscribing: Cuckoo.VerificationProxy {
        ...
        var requestId: Cuckoo.VerifyReadOnlyProperty<UInt16> {
            .init(manager: cuckoo_manager, name: "requestId", callMatcher: callMatcher, sourceLocation: sourceLocation)
        }

        var requestData: Cuckoo.VerifyReadOnlyProperty<Data> {
            .init(manager: cuckoo_manager, name: "requestData", callMatcher: callMatcher, sourceLocation: sourceLocation)
        }

        var requestOptions: Cuckoo.VerifyReadOnlyProperty<JSONRPCOptions> {
            .init(manager: cuckoo_manager, name: "requestOptions", callMatcher: callMatcher, sourceLocation: sourceLocation)
        }

        var remoteId: Cuckoo.VerifyOptionalProperty<String> {
            .init(manager: cuckoo_manager, name: "remoteId", callMatcher: callMatcher, sourceLocation: sourceLocation)
        }

        var unsubscribeMethod: Cuckoo.VerifyReadOnlyProperty<String> {
            .init(manager: cuckoo_manager, name: "unsubscribeMethod", callMatcher: callMatcher, sourceLocation: sourceLocation)
        }
...
public class JSONRPCSubscribingStub: JSONRPCSubscribing {
    public var requestId: UInt16 {
        DefaultValueRegistry.defaultValue(for: UInt16.self)
    }
    ...
    public var requestOptions: JSONRPCOptions {
        DefaultValueRegistry.defaultValue(for: JSONRPCOptions.self)
    }
    ...
    public func handle(data _: Data) throws {
        DefaultValueRegistry.defaultValue(for: Void.self)
    }

    public func handle(error _: Error, unsubscribed _: Bool) {
        DefaultValueRegistry.defaultValue(for: Void.self)
    }
}
...
public class MockJSONRPCEngine: JSONRPCEngine, Cuckoo.ProtocolMock {
    ...
    public func subscribe<P: Encodable, T: Decodable>(_ method: String, params: P?, unsubscribeMethod: String, updateClosure: @escaping (T) -> Void, failureClosure: @escaping (Error, Bool) -> Void) throws -> UInt16 {
        try cuckoo_manager.callThrows(
            "subscribe(_: String, params: P?, unsubscribeMethod: String, updateClosure: @escaping (T) -> Void, failureClosure: @escaping (Error, Bool) -> Void) throws -> UInt16",
    ...
    public func addBatchCallMethod<P: Encodable>(_ method: String, params: P?, batchId: JSONRPCBatchId) throws {
        try cuckoo_manager.callThrows(
            "addBatchCallMethod(_: String, params: P?, batchId: JSONRPCBatchId) throws",
    ...
    public func submitBatch(for batchId: JSONRPCBatchId, options: JSONRPCOptions, completion closure: (([Result<JSON, Error>]) -> Void)?) throws -> [UInt16] {
        try cuckoo_manager.callThrows(
            "submitBatch(for: JSONRPCBatchId, options: JSONRPCOptions, completion: (([Result<JSON, Error>]) -> Void)?) throws -> [UInt16]",
...
public class JSONRPCEngineStub: JSONRPCEngine {
    public func callMethod<P: Encodable, T: Decodable>(_: String, params _: P?, options _: JSONRPCOptions, completion _: ((Result<T, Error>) -> Void)?) throws -> UInt16 {
        DefaultValueRegistry.defaultValue(for: UInt16.self)
    }

    public func subscribe<P: Encodable, T: Decodable>(_: String, params _: P?, unsubscribeMethod _: String, updateClosure _: @escaping (T) -> Void, failureClosure _: @escaping (Error, Bool) -> Void) throws -> UInt16 {
        DefaultValueRegistry.defaultValue(for: UInt16.self)
    }

    public func cancelForIdentifiers(_: [UInt16]) {
        DefaultValueRegistry.defaultValue(for: Void.self)
    }

    public func addBatchCallMethod<P: Encodable>(_: String, params _: P?, batchId _: JSONRPCBatchId) throws {
        DefaultValueRegistry.defaultValue(for: Void.self)
    }

    public func submitBatch(for _: JSONRPCBatchId, options _: JSONRPCOptions, completion _: (([Result<JSON, Error>]) -> Void)?) throws -> [UInt16] {
        DefaultValueRegistry.defaultValue(for: [UInt16].self)
    }

    public func clearBatch(for _: JSONRPCBatchId) {
        DefaultValueRegistry.defaultValue(for: Void.self)
    }
}
...
class EventProtocolStub: EventProtocol {
    func accept(visitor _: EventVisitorProtocol) {
        DefaultValueRegistry.defaultValue(for: Void.self)
    }
}
...
class MockAccountRepositoryFactoryProtocol: AccountRepositoryFactoryProtocol, Cuckoo.ProtocolMock {
    ...
    func createFavoriteDAppsRepository() -> AnyDataProviderRepository<DAppFavorite> {
        cuckoo_manager.call(
            "createFavoriteDAppsRepository() -> AnyDataProviderRepository<DAppFavorite>",
            parameters: (),
            escapingParameters: (),
            superclassCall:
    ...
    func createAuthorizedDAppsRepository(for metaId: String?) -> AnyDataProviderRepository<DAppSettings> {
        cuckoo_manager.call(
            "createAuthorizedDAppsRepository(for: String?) -> AnyDataProviderRepository<DAppSettings>",
            parameters: metaId,
    ...
    func createDAppsGlobalSettingsRepository() -> AnyDataProviderRepository<DAppGlobalSettings> {
        cuckoo_manager.call(
            "createDAppsGlobalSettingsRepository() -> AnyDataProviderRepository<DAppGlobalSettings>",
            parameters: (),
            escapingParameters: (),
            superclassCall:
    ...
    func createDelegatedAccountSettingsRepository() -> AnyDataProviderRepository<DelegatedAccountSettings> {
        cuckoo_manager.call(
            "createDelegatedAccountSettingsRepository() -> AnyDataProviderRepository<DelegatedAccountSettings>",
            parameters: (),
            escapingParameters: (),
            superclassCall:
    ...
    struct __StubbingProxy_AccountRepositoryFactoryProtocol: Cuckoo.StubbingProxy {
        ...
        func createFavoriteDAppsRepository() -> Cuckoo.ProtocolStubFunction<Void, AnyDataProviderRepository<DAppFavorite>> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
        ...
        func createDAppsGlobalSettingsRepository() -> Cuckoo.ProtocolStubFunction<Void, AnyDataProviderRepository<DAppGlobalSettings>> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
        ...
        func createDelegatedAccountSettingsRepository() -> Cuckoo.ProtocolStubFunction<Void, AnyDataProviderRepository<DelegatedAccountSettings>> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
    ...
    struct __VerificationProxy_AccountRepositoryFactoryProtocol: Cuckoo.VerificationProxy {
        ...
        @discardableResult
        func createFavoriteDAppsRepository() -> Cuckoo.__DoNotUse<Void, AnyDataProviderRepository<DAppFavorite>> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
        ...
        @discardableResult
        func createDAppsGlobalSettingsRepository() -> Cuckoo.__DoNotUse<Void, AnyDataProviderRepository<DAppGlobalSettings>> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
        ...
        @discardableResult
        func createDelegatedAccountSettingsRepository() -> Cuckoo.__DoNotUse<Void, AnyDataProviderRepository<DelegatedAccountSettings>> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
...
class AccountRepositoryFactoryProtocolStub: AccountRepositoryFactoryProtocol {
    func createMetaAccountRepository(for _: NSPredicate?, sortDescriptors _: [NSSortDescriptor]) -> AnyDataProviderRepository<MetaAccountModel> {
        DefaultValueRegistry.defaultValue(for: AnyDataProviderRepository<MetaAccountModel>.self)
    }

    func createManagedMetaAccountRepository(for _: NSPredicate?, sortDescriptors _: [NSSortDescriptor]) -> AnyDataProviderRepository<ManagedMetaAccountModel> {
        DefaultValueRegistry.defaultValue(for: AnyDataProviderRepository<ManagedMetaAccountModel>.self)
    }

    func createFavoriteDAppsRepository() -> AnyDataProviderRepository<DAppFavorite> {
        DefaultValueRegistry.defaultValue(for: AnyDataProviderRepository<DAppFavorite>.self)
    }

    func createAuthorizedDAppsRepository(for _: String?) -> AnyDataProviderRepository<DAppSettings> {
        DefaultValueRegistry.defaultValue(for: AnyDataProviderRepository<DAppSettings>.self)
    }

    func createDAppsGlobalSettingsRepository() -> AnyDataProviderRepository<DAppGlobalSettings> {
        DefaultValueRegistry.defaultValue(for: AnyDataProviderRepository<DAppGlobalSettings>.self)
    }

    func createDelegatedAccountSettingsRepository() -> AnyDataProviderRepository<DelegatedAccountSettings> {
        DefaultValueRegistry.defaultValue(for: AnyDataProviderRepository<DelegatedAccountSettings>.self)
    }
}
...
class MockSchedulerProtocol: SchedulerProtocol, Cuckoo.ProtocolMock {
    ...
    struct __StubbingProxy_SchedulerProtocol: Cuckoo.StubbingProxy {
        ...
        var isScheduled: Cuckoo.ProtocolToBeStubbedReadOnlyProperty<MockSchedulerProtocol, Bool> {
            .init(manager: cuckoo_manager, name: "isScheduled")
        }
    ...
    struct __VerificationProxy_SchedulerProtocol: Cuckoo.VerificationProxy {
        ...
        var isScheduled: Cuckoo.VerifyReadOnlyProperty<Bool> {
            .init(manager: cuckoo_manager, name: "isScheduled", callMatcher: callMatcher, sourceLocation: sourceLocation)
        }
...
class SchedulerProtocolStub: SchedulerProtocol {
    ...
    func notifyAfter(_: TimeInterval) {
        DefaultValueRegistry.defaultValue(for: Void.self)
    }
...
class MockBiometryAuthProtocol: BiometryAuthProtocol, Cuckoo.ProtocolMock {
    ...
    struct __VerificationProxy_BiometryAuthProtocol: Cuckoo.VerificationProxy {
        ...
        var availableBiometryType: Cuckoo.VerifyReadOnlyProperty<AvailableBiometryType> {
            .init(manager: cuckoo_manager, name: "availableBiometryType", callMatcher: callMatcher, sourceLocation: sourceLocation)
        }

        var supportedBiometryType: Cuckoo.VerifyReadOnlyProperty<AvailableBiometryType> {
            .init(manager: cuckoo_manager, name: "supportedBiometryType", callMatcher: callMatcher, sourceLocation: sourceLocation)
        }
...
class BiometryAuthProtocolStub: BiometryAuthProtocol {
    var availableBiometryType: AvailableBiometryType {
        DefaultValueRegistry.defaultValue(for: AvailableBiometryType.self)
    }
    ...
    func authenticate(localizedReason _: String, completionQueue _: DispatchQueue, completionBlock _: @escaping (Bool) -> Void) {
        DefaultValueRegistry.defaultValue(for: Void.self)
    }
}
...
class BiometryAuthStub: BiometryAuth {
    ...
    override func authenticate(localizedReason _: String, completionQueue _: DispatchQueue, completionBlock _: @escaping (Bool) -> Void) {
        DefaultValueRegistry.defaultValue(for: Void.self)
    }
}
...
class MockConnectionAutobalancing: ConnectionAutobalancing, Cuckoo.ProtocolMock {
    ...
    struct __StubbingProxy_ConnectionAutobalancing: Cuckoo.StubbingProxy {
        ...
        var urls: Cuckoo.ProtocolToBeStubbedReadOnlyProperty<MockConnectionAutobalancing, [URL]> {
            .init(manager: cuckoo_manager, name: "urls")
        }
    ...
    struct __VerificationProxy_ConnectionAutobalancing: Cuckoo.VerificationProxy {
        ...
        var urls: Cuckoo.VerifyReadOnlyProperty<[URL]> {
            .init(manager: cuckoo_manager, name: "urls", callMatcher: callMatcher, sourceLocation: sourceLocation)
        }
...
class MockConnectionStateReporting: ConnectionStateReporting, Cuckoo.ProtocolMock {
    ...
    struct __StubbingProxy_ConnectionStateReporting: Cuckoo.StubbingProxy {
        ...
        var state: Cuckoo.ProtocolToBeStubbedReadOnlyProperty<MockConnectionStateReporting, WebSocketEngine.State> {
            .init(manager: cuckoo_manager, name: "state")
        }
    }
    ...
    struct __VerificationProxy_ConnectionStateReporting: Cuckoo.VerificationProxy {
        ...
        var state: Cuckoo.VerifyReadOnlyProperty<WebSocketEngine.State> {
            .init(manager: cuckoo_manager, name: "state", callMatcher: callMatcher, sourceLocation: sourceLocation)
        }
    }
}
...
class ConnectionStateReportingStub: ConnectionStateReporting {
    var state: WebSocketEngine.State {
        DefaultValueRegistry.defaultValue(for: WebSocketEngine.State.self)
    }
}
...
class DataOperationFactoryProtocolStub: DataOperationFactoryProtocol {
    func fetchData(from _: URL) -> BaseOperation<Data> {
        DefaultValueRegistry.defaultValue(for: BaseOperation<Data>.self)
    }
}
...
class MockChainRegistryProtocol: ChainRegistryProtocol, Cuckoo.ProtocolMock {
    ...
    func getChain(for chainId: ChainModel.Id) -> ChainModel? {
        cuckoo_manager.call(
            "getChain(for: ChainModel.Id) -> ChainModel?",
            parameters: chainId,
    ...
    func getOneShotConnection(for chainId: ChainModel.Id) -> JSONRPCEngine? {
        cuckoo_manager.call(
            "getOneShotConnection(for: ChainModel.Id) -> JSONRPCEngine?",
            parameters: chainId,
            escapingParameters: chainId,
            superclassCall:
    ...
    func switchSync(mode: ChainSyncMode, chainId: ChainModel.Id) throws {
        try cuckoo_manager.callThrows(
            "switchSync(mode: ChainSyncMode, chainId: ChainModel.Id) throws",
    ...
    func chainsSubscribe(_ target: AnyObject, runningInQueue: DispatchQueue, filterStrategy: ChainFilterStrategy?, updateClosure: @escaping ([DataProviderChange<ChainModel>]) -> Void) {
        cuckoo_manager.call(
            "chainsSubscribe(_: AnyObject, runningInQueue: DispatchQueue, filterStrategy: ChainFilterStrategy?, updateClosure: @escaping ([DataProviderChange<ChainModel>]) -> Void)",
    ...
    func subscribeChainState(_ subscriber: ConnectionStateSubscription, chainId: ChainModel.Id) {
        cuckoo_manager.call(
            "subscribeChainState(_: ConnectionStateSubscription, chainId: ChainModel.Id)",
    ...
    func unsubscribeChainState(_ subscriber: ConnectionStateSubscription, chainId: ChainModel.Id) {
        cuckoo_manager.call(
            "unsubscribeChainState(_: ConnectionStateSubscription, chainId: ChainModel.Id)",
            parameters: (subscriber, chainId),
            escapingParameters: (subscriber, chainId),
            superclassCall:
    ...
    struct __StubbingProxy_ChainRegistryProtocol: Cuckoo.StubbingProxy {
        ...
        var availableChainIds: Cuckoo.ProtocolToBeStubbedReadOnlyProperty<MockChainRegistryProtocol, Set<ChainModel.Id>?> {
            .init(manager: cuckoo_manager, name: "availableChainIds")
        }
        ...
        func syncUp() -> Cuckoo.ProtocolStubNoReturnFunction<Void> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
    ...
    struct __VerificationProxy_ChainRegistryProtocol: Cuckoo.VerificationProxy {
        ...
        var availableChainIds: Cuckoo.VerifyReadOnlyProperty<Set<ChainModel.Id>?> {
            .init(manager: cuckoo_manager, name: "availableChainIds", callMatcher: callMatcher, sourceLocation: sourceLocation)
        }
        ...
        @discardableResult
        func syncUp() -> Cuckoo.__DoNotUse<Void, Void> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
...
class ChainRegistryProtocolStub: ChainRegistryProtocol {
    var availableChainIds: Set<ChainModel.Id>? {
        DefaultValueRegistry.defaultValue(for: (Set<ChainModel.Id>?).self)
    }

    func getChain(for _: ChainModel.Id) -> ChainModel? {
        DefaultValueRegistry.defaultValue(for: (ChainModel?).self)
    }

    func getConnection(for _: ChainModel.Id) -> ChainConnection? {
        DefaultValueRegistry.defaultValue(for: (ChainConnection?).self)
    }

    func getOneShotConnection(for _: ChainModel.Id) -> JSONRPCEngine? {
        DefaultValueRegistry.defaultValue(for: (JSONRPCEngine?).self)
    }

    func getRuntimeProvider(for _: ChainModel.Id) -> RuntimeProviderProtocol? {
        DefaultValueRegistry.defaultValue(for: (RuntimeProviderProtocol?).self)
    }
    ...
    func chainsSubscribe(_: AnyObject, runningInQueue _: DispatchQueue, filterStrategy _: ChainFilterStrategy?, updateClosure _: @escaping ([DataProviderChange<ChainModel>]) -> Void) {
        DefaultValueRegistry.defaultValue(for: Void.self)
    }
...
class MockConnectionFactoryProtocol: ConnectionFactoryProtocol, Cuckoo.ProtocolMock {
    ...
    func createConnection(for chain: ChainNodeConnectable, delegate: WebSocketEngineDelegate?) throws -> ChainConnection {
        try cuckoo_manager.callThrows(
            "createConnection(for: ChainNodeConnectable, delegate: WebSocketEngineDelegate?) throws -> ChainConnection",
    ...
    func createConnection(for node: ChainNodeModel, chain: ChainNodeConnectable, delegate: WebSocketEngineDelegate?) throws -> ChainConnection {
        try cuckoo_manager.callThrows(
            "createConnection(for: ChainNodeModel, chain: ChainNodeConnectable, delegate: WebSocketEngineDelegate?) throws -> ChainConnection",
    ...
    func updateConnection(_ connection: ChainConnection, chain: ChainNodeConnectable) {
        cuckoo_manager.call(
            "updateConnection(_: ChainConnection, chain: ChainNodeConnectable)",
    ...
    func updateOneShotConnection(_ connection: OneShotConnection, chain: ChainNodeConnectable) {
        cuckoo_manager.call(
            "updateOneShotConnection(_: OneShotConnection, chain: ChainNodeConnectable)",
            parameters: (connection, chain),
            escapingParameters: (connection, chain),
            superclassCall:
    ...
    func createOneShotConnection(for chain: ChainNodeConnectable) throws -> OneShotConnection {
        try cuckoo_manager.callThrows(
            "createOneShotConnection(for: ChainNodeConnectable) throws -> OneShotConnection",
            parameters: chain,
...
class ConnectionFactoryProtocolStub: ConnectionFactoryProtocol {
    func createConnection(for _: ChainNodeConnectable, delegate _: WebSocketEngineDelegate?) throws -> ChainConnection {
        DefaultValueRegistry.defaultValue(for: ChainConnection.self)
    }

    func createConnection(for _: ChainNodeModel, chain _: ChainNodeConnectable, delegate _: WebSocketEngineDelegate?) throws -> ChainConnection {
        DefaultValueRegistry.defaultValue(for: ChainConnection.self)
    }
    ...
    func createOneShotConnection(for _: ChainNodeConnectable) throws -> OneShotConnection {
        DefaultValueRegistry.defaultValue(for: OneShotConnection.self)
    }
}
...
class MockConnectionPoolProtocol: ConnectionPoolProtocol, Cuckoo.ProtocolMock {
    ...
    func subscribe(_ subscriber: ConnectionStateSubscription, chainId: ChainModel.Id) {
        cuckoo_manager.call(
            "subscribe(_: ConnectionStateSubscription, chainId: ChainModel.Id)",
            parameters: (subscriber, chainId),
            escapingParameters: (subscriber, chainId),
            superclassCall:
    ...
    func unsubscribe(_ subscriber: ConnectionStateSubscription, chainId: ChainModel.Id) {
        cuckoo_manager.call(
            "unsubscribe(_: ConnectionStateSubscription, chainId: ChainModel.Id)",
            parameters: (subscriber, chainId),
            escapingParameters: (subscriber, chainId),
            superclassCall:
    ...
    func getOneShotConnection(for chain: ChainModel) -> JSONRPCEngine? {
        cuckoo_manager.call(
            "getOneShotConnection(for: ChainModel) -> JSONRPCEngine?",
            parameters: chain,
            escapingParameters: chain,
            superclassCall:
    ...
    func deactivateConnection(for chainId: ChainModel.Id) {
        cuckoo_manager.call(
            "deactivateConnection(for: ChainModel.Id)",
            parameters: chainId,
            escapingParameters: chainId,
            superclassCall:
...
class ConnectionPoolProtocolStub: ConnectionPoolProtocol {
    func setupConnection(for _: ChainModel) throws -> ChainConnection {
        DefaultValueRegistry.defaultValue(for: ChainConnection.self)
    }
    ...
    func subscribe(_: ConnectionStateSubscription, chainId _: ChainModel.Id) {
        DefaultValueRegistry.defaultValue(for: Void.self)
    }

    func unsubscribe(_: ConnectionStateSubscription, chainId _: ChainModel.Id) {
        DefaultValueRegistry.defaultValue(for: Void.self)
    }

    func getOneShotConnection(for _: ChainModel) -> JSONRPCEngine? {
        DefaultValueRegistry.defaultValue(for: (JSONRPCEngine?).self)
    }

    func deactivateConnection(for _: ChainModel.Id) {
        DefaultValueRegistry.defaultValue(for: Void.self)
    }
}
...
class MockConnectionStateSubscription: ConnectionStateSubscription, Cuckoo.ProtocolMock {
    ...
    func didReceive(state: WebSocketEngine.State, for chainId: ChainModel.Id) {
        cuckoo_manager.call(
            "didReceive(state: WebSocketEngine.State, for: ChainModel.Id)",
    ...
    func didSwitchURL(_ connection: ChainConnection, newURL: URL, for chainId: ChainModel.Id) {
        cuckoo_manager.call(
            "didSwitchURL(_: ChainConnection, newURL: URL, for: ChainModel.Id)",
...
class ConnectionStateSubscriptionStub: ConnectionStateSubscription {
    func didReceive(state _: WebSocketEngine.State, for _: ChainModel.Id) {
        DefaultValueRegistry.defaultValue(for: Void.self)
    }

    func didSwitchURL(_: ChainConnection, newURL _: URL, for _: ChainModel.Id) {
        DefaultValueRegistry.defaultValue(for: Void.self)
    }
}
...
class MockConnectionPool: ConnectionPool, Cuckoo.ClassMock {
    ...
    struct __VerificationProxy_ConnectionPool: Cuckoo.VerificationProxy {
        ...
        var connections: Cuckoo.VerifyReadOnlyProperty<[ChainModel.Id: WeakWrapper]> {
            .init(manager: cuckoo_manager, name: "connections", callMatcher: callMatcher, sourceLocation: sourceLocation)
        }

        var oneShotConnections: Cuckoo.VerifyReadOnlyProperty<[ChainModel.Id: OneShotConnection]> {
            .init(manager: cuckoo_manager, name: "oneShotConnections", callMatcher: callMatcher, sourceLocation: sourceLocation)
        }

        var stateSubscriptions: Cuckoo.VerifyReadOnlyProperty<[ChainModel.Id: [WeakWrapper]]> {
            .init(manager: cuckoo_manager, name: "stateSubscriptions", callMatcher: callMatcher, sourceLocation: sourceLocation)
        }
    }
}
...
class ConnectionPoolStub: ConnectionPool {
    override var connections: [ChainModel.Id: WeakWrapper] {
        DefaultValueRegistry.defaultValue(for: [ChainModel.Id: WeakWrapper].self)
    }

    override var oneShotConnections: [ChainModel.Id: OneShotConnection] {
        DefaultValueRegistry.defaultValue(for: [ChainModel.Id: OneShotConnection].self)
    }
...
class MockRuntimeFilesOperationFactoryProtocol: RuntimeFilesOperationFactoryProtocol, Cuckoo.ProtocolMock {
    ...
    struct __StubbingProxy_RuntimeFilesOperationFactoryProtocol: Cuckoo.StubbingProxy {
        ...
        func fetchCommonTypesOperation() -> Cuckoo.ProtocolStubFunction<Void, CompoundOperationWrapper<Data?>> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
    ...
    struct __VerificationProxy_RuntimeFilesOperationFactoryProtocol: Cuckoo.VerificationProxy {
        ...
        @discardableResult
        func fetchCommonTypesOperation() -> Cuckoo.__DoNotUse<Void, CompoundOperationWrapper<Data?>> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
...
class RuntimeFilesOperationFactoryProtocolStub: RuntimeFilesOperationFactoryProtocol {
    func fetchCommonTypesOperation() -> CompoundOperationWrapper<Data?> {
        DefaultValueRegistry.defaultValue(for: CompoundOperationWrapper<Data?>.self)
    }
    ...
    func saveCommonTypesOperation(data _: @escaping () throws -> Data) -> CompoundOperationWrapper<Void> {
        DefaultValueRegistry.defaultValue(for: CompoundOperationWrapper<Void>.self)
    }

    func saveChainTypesOperation(for _: ChainModel.Id, data _: @escaping () throws -> Data) -> CompoundOperationWrapper<Void> {
        DefaultValueRegistry.defaultValue(for: CompoundOperationWrapper<Void>.self)
    }
}
...
class MockCommonTypesSyncService: CommonTypesSyncService, Cuckoo.ClassMock {
    ...
    struct __StubbingProxy_CommonTypesSyncService: Cuckoo.StubbingProxy {
        ...
        var isSyncing: Cuckoo.ClassToBeStubbedReadOnlyProperty<MockCommonTypesSyncService, Bool> {
            .init(manager: cuckoo_manager, name: "isSyncing")
        }

        var retryAttempt: Cuckoo.ClassToBeStubbedReadOnlyProperty<MockCommonTypesSyncService, Int> {
            .init(manager: cuckoo_manager, name: "retryAttempt")
        }
    }
    ...
    struct __VerificationProxy_CommonTypesSyncService: Cuckoo.VerificationProxy {
        ...
        var isSyncing: Cuckoo.VerifyReadOnlyProperty<Bool> {
            .init(manager: cuckoo_manager, name: "isSyncing", callMatcher: callMatcher, sourceLocation: sourceLocation)
        }

        var retryAttempt: Cuckoo.VerifyReadOnlyProperty<Int> {
            .init(manager: cuckoo_manager, name: "retryAttempt", callMatcher: callMatcher, sourceLocation: sourceLocation)
        }
    }
}
...
class CommonTypesSyncServiceStub: CommonTypesSyncService {
    ...
    override var retryAttempt: Int {
        DefaultValueRegistry.defaultValue(for: Int.self)
    }
}
...
class MockRuntimeCodingServiceProtocol: RuntimeCodingServiceProtocol, Cuckoo.ProtocolMock {
    ...
    func fetchCoderFactoryOperation() -> BaseOperation<RuntimeCoderFactoryProtocol> {
        cuckoo_manager.call(
            "fetchCoderFactoryOperation() -> BaseOperation<RuntimeCoderFactoryProtocol>",
            parameters: (),
            escapingParameters: (),
            superclassCall:
    ...
    struct __StubbingProxy_RuntimeCodingServiceProtocol: Cuckoo.StubbingProxy {
        ...
        func fetchCoderFactoryOperation() -> Cuckoo.ProtocolStubFunction<Void, BaseOperation<RuntimeCoderFactoryProtocol>> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
    ...
    struct __VerificationProxy_RuntimeCodingServiceProtocol: Cuckoo.VerificationProxy {
        ...
        @discardableResult
        func fetchCoderFactoryOperation() -> Cuckoo.__DoNotUse<Void, BaseOperation<RuntimeCoderFactoryProtocol>> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
...
class RuntimeCodingServiceProtocolStub: RuntimeCodingServiceProtocol {
    func fetchCoderFactoryOperation() -> BaseOperation<RuntimeCoderFactoryProtocol> {
        DefaultValueRegistry.defaultValue(for: BaseOperation<RuntimeCoderFactoryProtocol>.self)
    }
}
...
class MockRuntimeProviderProtocol: RuntimeProviderProtocol, Cuckoo.ProtocolMock {
    ...
    struct __StubbingProxy_RuntimeProviderProtocol: Cuckoo.StubbingProxy {
        ...
        var chainId: Cuckoo.ProtocolToBeStubbedReadOnlyProperty<MockRuntimeProviderProtocol, ChainModel.Id> {
            .init(manager: cuckoo_manager, name: "chainId")
        }

        var hasSnapshot: Cuckoo.ProtocolToBeStubbedReadOnlyProperty<MockRuntimeProviderProtocol, Bool> {
            .init(manager: cuckoo_manager, name: "hasSnapshot")
        }

        func setup() -> Cuckoo.ProtocolStubNoReturnFunction<Void> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
        ...
        func cleanup() -> Cuckoo.ProtocolStubNoReturnFunction<Void> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
    ...
    struct __VerificationProxy_RuntimeProviderProtocol: Cuckoo.VerificationProxy {
        ...
        var chainId: Cuckoo.VerifyReadOnlyProperty<ChainModel.Id> {
            .init(manager: cuckoo_manager, name: "chainId", callMatcher: callMatcher, sourceLocation: sourceLocation)
        }

        var hasSnapshot: Cuckoo.VerifyReadOnlyProperty<Bool> {
            .init(manager: cuckoo_manager, name: "hasSnapshot", callMatcher: callMatcher, sourceLocation: sourceLocation)
        }

        @discardableResult
        func setup() -> Cuckoo.__DoNotUse<Void, Void> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
        ...
        @discardableResult
        func cleanup() -> Cuckoo.__DoNotUse<Void, Void> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
...
class RuntimeProviderProtocolStub: RuntimeProviderProtocol {
    var chainId: ChainModel.Id {
        DefaultValueRegistry.defaultValue(for: ChainModel.Id.self)
    }
...
class MockRuntimeProviderFactoryProtocol: RuntimeProviderFactoryProtocol, Cuckoo.ProtocolMock {
    ...
    func createRuntimeProvider(for chain: ChainModel) -> RuntimeProviderProtocol {
        cuckoo_manager.call(
            "createRuntimeProvider(for: ChainModel) -> RuntimeProviderProtocol",
            parameters: chain,
            escapingParameters: chain,
            superclassCall:
...
class RuntimeProviderFactoryProtocolStub: RuntimeProviderFactoryProtocol {
    func createRuntimeProvider(for _: ChainModel) -> RuntimeProviderProtocol {
        DefaultValueRegistry.defaultValue(for: RuntimeProviderProtocol.self)
    }
}
...
class MockRuntimeProviderPoolProtocol: RuntimeProviderPoolProtocol, Cuckoo.ProtocolMock {
    ...
    func setupRuntimeProviderIfNeeded(for chain: ChainModel) -> RuntimeProviderProtocol {
        cuckoo_manager.call(
            "setupRuntimeProviderIfNeeded(for: ChainModel) -> RuntimeProviderProtocol",
            parameters: chain,
            escapingParameters: chain,
            superclassCall:
    ...
    func destroyRuntimeProviderIfExists(for chainId: ChainModel.Id) {
        cuckoo_manager.call(
            "destroyRuntimeProviderIfExists(for: ChainModel.Id)",
            parameters: chainId,
            escapingParameters: chainId,
            superclassCall:
...
class RuntimeProviderPoolProtocolStub: RuntimeProviderPoolProtocol {
    func setupRuntimeProviderIfNeeded(for _: ChainModel) -> RuntimeProviderProtocol {
        DefaultValueRegistry.defaultValue(for: RuntimeProviderProtocol.self)
    }

    func destroyRuntimeProviderIfExists(for _: ChainModel.Id) {
        DefaultValueRegistry.defaultValue(for: Void.self)
    }
...
class MockRuntimeSyncServiceProtocol: RuntimeSyncServiceProtocol, Cuckoo.ProtocolMock {
    ...
    func unregisterIfExists(chainId: ChainModel.Id) {
        cuckoo_manager.call(
            "unregisterIfExists(chainId: ChainModel.Id)",
            parameters: chainId,
            escapingParameters: chainId,
            superclassCall:
...
class RuntimeSyncServiceProtocolStub: RuntimeSyncServiceProtocol {
    func register(chain _: ChainModel, with _: ChainConnection) {
        DefaultValueRegistry.defaultValue(for: Void.self)
    }

    func unregisterIfExists(chainId _: ChainModel.Id) {
        DefaultValueRegistry.defaultValue(for: Void.self)
    }

    func apply(version _: RuntimeVersion, for _: ChainModel.Id) {
        DefaultValueRegistry.defaultValue(for: Void.self)
    }

    func hasChain(with _: ChainModel.Id) -> Bool {
        DefaultValueRegistry.defaultValue(for: Bool.self)
    }
...
class MockSpecVersionSubscriptionProtocol: SpecVersionSubscriptionProtocol, Cuckoo.ProtocolMock {
    ...
    struct __StubbingProxy_SpecVersionSubscriptionProtocol: Cuckoo.StubbingProxy {
        ...
        func subscribe() -> Cuckoo.ProtocolStubNoReturnFunction<Void> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
        ...
        func unsubscribe() -> Cuckoo.ProtocolStubNoReturnFunction<Void> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
...
class MockSpecVersionSubscriptionFactoryProtocol: SpecVersionSubscriptionFactoryProtocol, Cuckoo.ProtocolMock {
    ...
    func createSubscription(for chain: ChainModel, connection: JSONRPCEngine) -> SpecVersionSubscriptionProtocol {
        cuckoo_manager.call(
            "createSubscription(for: ChainModel, connection: JSONRPCEngine) -> SpecVersionSubscriptionProtocol",
            parameters: (chain, connection),
            escapingParameters: (chain, connection),
            superclassCall:
...
class SpecVersionSubscriptionFactoryProtocolStub: SpecVersionSubscriptionFactoryProtocol {
    func createSubscription(for _: ChainModel, connection _: JSONRPCEngine) -> SpecVersionSubscriptionProtocol {
        DefaultValueRegistry.defaultValue(for: SpecVersionSubscriptionProtocol.self)
    }
}
...
class CrowdloanRemoteSubscriptionServiceProtocolStub: CrowdloanRemoteSubscriptionServiceProtocol {
    func attach(for _: ChainModel.Id, runningCompletionIn _: DispatchQueue?, completion _: RemoteSubscriptionClosure?) -> UUID? {
        DefaultValueRegistry.defaultValue(for: (UUID?).self)
    }

    func detach(for _: UUID, chainId _: ChainModel.Id, runningCompletionIn _: DispatchQueue?, completion _: RemoteSubscriptionClosure?) {
        DefaultValueRegistry.defaultValue(for: Void.self)
    }
}
...
class CrowdloanRemoteSubscriptionServiceStub: CrowdloanRemoteSubscriptionService {
    override func attach(for _: ChainModel.Id, runningCompletionIn _: DispatchQueue?, completion _: RemoteSubscriptionClosure?) -> UUID? {
        DefaultValueRegistry.defaultValue(for: (UUID?).self)
    }

    override func detach(for _: UUID, chainId _: ChainModel.Id, runningCompletionIn _: DispatchQueue?, completion _: RemoteSubscriptionClosure?) {
        DefaultValueRegistry.defaultValue(for: Void.self)
    }
}
...
class MockStakingAccountUpdatingServiceProtocol: StakingAccountUpdatingServiceProtocol, Cuckoo.ProtocolMock {
    ...
    func setupSubscription(for accountId: AccountId, chainId: ChainModel.Id, chainFormat: ChainFormat) throws {
        try cuckoo_manager.callThrows(
            "setupSubscription(for: AccountId, chainId: ChainModel.Id, chainFormat: ChainFormat) throws",
    ...
    struct __StubbingProxy_StakingAccountUpdatingServiceProtocol: Cuckoo.StubbingProxy {
        ...
        func clearSubscription() -> Cuckoo.ProtocolStubNoReturnFunction<Void> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
    ...
    struct __VerificationProxy_StakingAccountUpdatingServiceProtocol: Cuckoo.VerificationProxy {
        ...
        @discardableResult
        func clearSubscription() -> Cuckoo.__DoNotUse<Void, Void> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
...
class StakingAccountUpdatingServiceProtocolStub: StakingAccountUpdatingServiceProtocol {
    func setupSubscription(for _: AccountId, chainId _: ChainModel.Id, chainFormat _: ChainFormat) throws {
        DefaultValueRegistry.defaultValue(for: Void.self)
    }
...
class MockStakingAccountUpdatingService: StakingAccountUpdatingService, Cuckoo.ClassMock {
    ...
    struct __StubbingProxy_StakingAccountUpdatingService: Cuckoo.StubbingProxy {
        ...
        func clearSubscription() -> Cuckoo.ClassStubNoReturnFunction<Void> {
            let matchers: [Cuckoo.ParameterMatcher<Void>] = []
...
class StakingAccountUpdatingServiceStub: StakingAccountUpdatingService {
    override func setupSubscription(for _: AccountId, chainId _: ChainModel.Id, chainFormat _: ChainFormat) throws {
        DefaultValueRegistry.defaultValue(for: Void.self)
    }
...
class MockStakingServiceFactoryProtocol: StakingServiceFactoryProtocol, Cuckoo.ProtocolMock {
    ...
    func createEraValidatorService(for chainId: ChainModel.Id, localSubscriptionFactory: StakingLocalSubscriptionFactoryProtocol) throws -> EraValidatorServiceProtocol {
        try cuckoo_manager.callThrows(
            "createEraValidatorService(for: ChainModel.Id, localSubscriptionFactory: StakingLocalSubscriptionFactoryProtocol) throws -> EraValidatorServiceProtocol",
    ...
    func createRewardCalculatorService(for chainAsset: ChainAsset, stakingType: StakingType, stakingLocalSubscriptionFactory: StakingLocalSubscriptionFactoryProtocol, stakingDurationFactory: StakingDurationOperationFactoryProtocol, validatorService: EraValidatorServiceProtocol) throws -> RewardCalculatorServiceProtocol {
        try cuckoo_manager.callThrows(
            "createRewardCalculatorService(for: ChainAsset, stakingType: StakingType, stakingLocalSubscriptionFactory: StakingLocalSubscriptionFactoryProtocol, stakingDurationFactory: StakingDurationOperationFactoryProtocol, validatorService: EraValidatorServiceProtocol) throws -> RewardCalculatorServiceProtocol",
    ...
    func createTimeModel(for chainId: ChainModel.Id, consensus: RelayStkConsensusType) throws -> StakingTimeModel {
        try cuckoo_manager.callThrows(
            "createTimeModel(for: ChainModel.Id, consensus: RelayStkConsensusType) throws -> StakingTimeModel",
...
class StakingServiceFactoryProtocolStub: StakingServiceFactoryProtocol {
    func createEraValidatorService(for _: ChainModel.Id, localSubscriptionFactory _: StakingLocalSubscriptionFactoryProtocol) throws -> EraValidatorServiceProtocol {
        DefaultValueRegistry.defaultValue(for: EraValidatorServiceProtocol.self)
    }

    func createRewardCalculatorService(for _: ChainAsset, stakingType _: StakingType, stakingLocalSubscriptionFactory _: StakingLocalSubscriptionFactoryProtocol, stakingDurationFactory _: StakingDurationOperationFactoryProtocol, validatorService _: EraValidatorServiceProtocol) throws -> RewardCalculatorServiceProtocol {
        DefaultValueRegistry.defaultValue(for: RewardCalculatorServiceProtocol.self)
    }

    func createTimeModel(for _: ChainModel.Id, consensus _: RelayStkConsensusType) throws -> StakingTimeModel {
        DefaultValueRegistry.defaultValue(for: StakingTimeModel.self)
    }
}
