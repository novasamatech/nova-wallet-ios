...
final class WalletManagementPresenter {
    weak var view: WalletManagementViewProtocol?
    var wireframe: WalletManagementWireframeProtocol!
    var interactor: WalletManagementInteractorInputProtocol!

    let viewModelFactory: ManagedWalletViewModelFactoryProtocol

    private var viewModels: [ManagedWalletViewModelItem] = []
    ...
    init(viewModelFactory: ManagedWalletViewModelFactoryProtocol) {
...
extension WalletManagementPresenter: WalletManagementPresenterProtocol {
    func setup() {
        interactor.setup()
    }
    ...
    func activateDetails(at index: Int) {
        ...
        if let item = listCalculator.allItems.first(
            ...
            wireframe.showWalletDetails(from: view, metaAccount: item.info)
        }
    }
...
extension WalletManagementPresenter: WalletManagementInteractorOutputProtocol {
...
extension WalletManagementPresenter: Localizable {
