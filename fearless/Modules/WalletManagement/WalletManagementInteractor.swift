...
final class WalletManagementInteractor {
    weak var presenter: WalletManagementInteractorOutputProtocol?
...
extension WalletManagementInteractor: WalletManagementInteractorInputProtocol {
    func setup() {
